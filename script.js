class Cicle {
    ...
    toString(){
        console.log(`Nom del cicle: ${nom} Categoria: ${categoria} Número d'alumnes: ${numAlumnes} Abreviatura del cicle: ${abreviatura} Data de creació: ${dataCreacio}`);
    }
...
function afegirCicle(){
    ...
    let cicle = {nom: nom, categoria: categoria, numAlumnes: numAlumnes, abreviatura: abreviatura, dataCreacio: dataCreacio}
    console.log(cicle);
